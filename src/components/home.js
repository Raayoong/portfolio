...
const Home = () => {
  return (
    <section id="Home" className="h-screen flex items-center justify-center pb-[13rem] pt-20">
      <div className="flex flex-row items-center justify-center gap-14 border-[1px] p-8 rounded-2xl shadow-md">
        <figure>
          <img className="w-[300px]" src={Profile} alt="" />
        </figure>
        <div className="flex flex-col">
            <h1 className="text-6xl font-bold">Hi!</h1>
            <h1 className="text-6xl pb-4 font-bold"> I'm <span className="text-blue-500">Ryan Campos</span></h1>
            <h2 className="text-2xl text-blue-500 font-semibold pb-12">Front-end Developer</h2>
